...
See [docs/writeup](../docs/writeup/writeup.md) for the full narrative writeup and [docs/testing_methodology.md](../docs/testing_methodology.md) for the test plan this was validated against.
