// Original webpack module: 43027 (MultiOutlet API handler)
const { APIHandler } = require("./api-handler-base");

class MultiOutletAPIHandler extends APIHandler {
  constructor() {
    super();
    this.nsDeviceType = "multiOutlet";
  }
...
module.exports = { MultiOutletAPIHandler };
