...
- `rkbin/` (submodule) - Rockchip boot/loader binaries, needed to flash/boot P1606 (Rockchip-based hub - see the open architecture question in [fcc_filings/2ATM71605](../fcc_filings/2ATM71605))
- [`datasheets/`](datasheets) - manufacturer datasheets for chips identified via [fcc_filings/](../fcc_filings)
